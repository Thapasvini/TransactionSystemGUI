...
public class SignupOne extends JFrame implements ActionListener
{
    ...
    JTextField nameTextField,fnameTextField,dobTextField,mailIdTextField,addressTextField, cityTextField,stateTextField,pinTextField;
    JButton next;
    ...
    SignupOne(String formno)
    {
        ...
        JLabel personalDetails= new JLabel("Page 1: Applicant Details");
        ...
        ButtonGroup genedergroup= new ButtonGroup();
        genedergroup.add(male);
        genedergroup.add(female);
        
        JLabel mailId= new JLabel("Mail Id :");
        mailId.setFont( new Font("Raleway", Font.BOLD, 20));
        mailId.setBounds(100,340,200,30);
        add(mailId);
        
        mailIdTextField = new JTextField();
        mailIdTextField.setFont( new Font("Raleway", Font.BOLD, 14));
        mailIdTextField.setBounds(300, 340, 400, 30);
        add(mailIdTextField);
        ...
        JLabel pinCode= new JLabel("ZipCode :");
    ...
    {
        String formno=""+random;// random is long value we have to enter only string values in database
        ...
        String zipcode= pinTextField.getText();
        ...
        try
        {
            ...
            // to show a dialog or a popup mesage we use JOption
            }
            else
                    {
                        Conn c= new Conn();
